 ...
 * @author user
 */
public class Admin_Navigator extends javax.swing.JFrame {

    /**
     * Creates new form navigator
     */
    public Admin_Navigator() {
        initComponents();
        // Display current date as well as user data
    ...
    private void Register1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Register1MouseClicked
        try {
            ...
            Logger.getLogger(Admin_Navigator.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Navigator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Navigator().setVisible(true);
            }
        });
    }
