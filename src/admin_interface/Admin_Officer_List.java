 ...
 * @author user
 */
public class Admin_Officer_List extends javax.swing.JFrame {

    /**
     * Creates new form navigator
     */
    public Admin_Officer_List() {
        initComponents();
    ...
    // Transfer to other interface
    public void to_officer(){
        Admin_Officer_Modify a = new Admin_Officer_Modify();
        a.setVisible(true);
    ...
    private void initComponents() {
        ...
        searchOfficer = new javax.swing.JTextField();
        ...
        officerTable.setModel(model);
        officerTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        officerTable.setGridColor(new java.awt.Color(255, 255, 255));
        officerTable.setSelectionBackground(new java.awt.Color(102, 102, 102));
        ...
        officerTable.setRowHeight(35);
        officerTable.getColumnModel().getColumn(0).setPreferredWidth(115); // Name
        officerTable.getColumnModel().getColumn(1).setPreferredWidth(200); // Contact
        officerTable.getColumnModel().getColumn(2).setPreferredWidth(145); // IC
        officerTable.getColumnModel().getColumn(3).setPreferredWidth(110); // Username
        officerTable.getColumnModel().getColumn(4).setPreferredWidth(100); // Actions

        officerTable.getTableHeader().setDefaultRenderer((table, value, isSelected, hasFocus, row, column) -> {
        ...
        // button of view
        TableColumn actionsColumn = officerTable.getColumnModel().getColumn(4);
        ...
        officerTable.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                int selectedRow = officerTable.getSelectedRow();
                if (selectedRow != -1 && officerTable.columnAtPoint(e.getPoint()) == 4) {
                    int modelRow = officerTable.convertRowIndexToModel(selectedRow);
                    String username = (String) officerTable.getModel().getValueAt(modelRow, 3);

                    try{
                        Officer obj1 = new Officer(username);
                        String res = obj1.view_Officer();
                        if(res == "Success"){
                            to_officer();
                        }
                        ...
                        Logger.getLogger(Admin_Officer_List.class.getName()).log(Level.SEVERE, null, ex);
                    }
        ...
        searchOfficer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                searchOfficerKeyReleased(evt);
            }
        });
        background.add(searchOfficer, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 370, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel2.setText("Searching For Officers : ");
        background.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, -1, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 3, 24)); // NOI18N
        jLabel3.setText("Officer List");
    ...
    private void searchOfficerKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchOfficerKeyReleased
        // Seaching Officer Feature
        DefaultTableModel obj = (DefaultTableModel) officerTable.getModel();
        TableRowSorter<DefaultTableModel> obj1 = new TableRowSorter<>(obj);
        officerTable.setRowSorter(obj1);
        obj1.setRowFilter(RowFilter.regexFilter(searchOfficer.getText()));
        
    }//GEN-LAST:event_searchOfficerKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Officer_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Officer_List().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField searchOfficer;
