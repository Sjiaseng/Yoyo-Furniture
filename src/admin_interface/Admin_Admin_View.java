 ...
 * @author user
 */
public class Admin_Admin_View extends javax.swing.JFrame {

    /**
     * Creates new form navigator
     */
    public Admin_Admin_View() {
        initComponents();
        ...
        String[] admin_data = Admin.admin_info;
        // Retrieve Data from Array Which Stores Data
        name.setText(admin_data[0]);
        email.setText(admin_data[1]);
        phone.setText(admin_data[3]);
        ic.setText(admin_data[4]);
        date.setText(admin_data[5]);
        username.setText(admin_data[7]);
        
        
        String mygender = admin_data[2];
        String myrole = admin_data[6];
    ...
    private void initComponents() {
        ...
        background.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 420, 220, 30));

        regdate.setText("Registration Date : ");
        background.add(regdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 390, 110, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 3, 24)); // NOI18N
        jLabel2.setText("View Admin Profile");
        background.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, -1));

        name.setEditable(false);
        background.add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, 220, -1));

        jLabel3.setText("Name :");
        background.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 130, -1, -1));

        gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Male", "Female" }));
        gender.setEnabled(false);
        background.add(gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 160, 220, -1));

        jLabel4.setText("Gender :");
        background.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 130, -1, -1));

        phone.setEditable(false);
        background.add(phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 240, 220, -1));

        jLabel6.setText("Phone Number :");
        background.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 210, -1, -1));

        email.setEditable(false);
        background.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, 220, -1));

        jLabel5.setText("Email :");
        background.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, -1, -1));

        username.setEditable(false);
        background.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 330, 220, -1));

        jLabel7.setText("Username :");
        background.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 300, -1, -1));

        role.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "None", "Administrator", "Officer", "Sales Person" }));
        role.setEnabled(false);
        background.add(role, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 330, 220, -1));

        jLabel8.setText("Role :");
        background.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 300, -1, -1));

        ic.setEditable(false);
        background.add(ic, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 420, 220, -1));

        jLabel10.setText("IC Number :");
        background.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 390, -1, -1));
        ...
        background.add(backBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 480, 70, 30));
    ...
    private void Register1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Register1MouseClicked
        try {
            ...
            Logger.getLogger(Admin_Admin_View.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Admin_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Admin_View().setVisible(true);
            }
        });
    }
